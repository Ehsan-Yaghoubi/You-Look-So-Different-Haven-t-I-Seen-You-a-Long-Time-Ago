...
# Therefore, if you want to your configurations, please create your_costumed.yml file, instead of changing this _01_preprocessing_step.
# -----------------------------------------------------------------------------
...
_C.DATASETS.NAMES = ('') # shapes_varcolor, shapes_fixcolor, ltcc_noneID, ltcc_orig
