...
class NKUP_noneID(BaseImageDataset):
    """
    ...
    def __init__(self,root='', verbose=True, **kwargs):
        super(NKUP_noneID, self).__init__()
    ...
    def _process_dir(self, dir_path, list_path, relabel=False):
        ...
        for img_idx, img_info in enumerate(list_path):
            pid = img_info.split('_')[2] + img_info.split('_')[3]
        ...
        for img_idx, img_info in enumerate(list_path):
            ...
            pid = img_info.split('_')[2] + img_info.split('_')[3]
            camid = int(img_info.split('_')[4].split("S")[0].split("C")[1])
            feat2_dir = None
            clothid = img_info.split('_')[3].split("D")[1]
